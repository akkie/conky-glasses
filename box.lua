...
function conky_main_box()
    ...
    local margin=conky_window.border_inner_margin 
    local width=conky_window.width-(2*margin)
    local height=24
    local title_sp_color={1,0xFFA300,1}
    local graph_sp_color={1,0xFFA300,0.1}  
    local graph_bg_color={1,0x181818,0.5}
    local boxes_settings={   
    --Title Spacer
        --System
            {x=margin, y=24,w=width,h=1, colour={ title_sp_color }},
        --CPU 
            {x=margin, y=122,w=width,h=1, colour={ title_sp_color }},
        --MEM 
            {x=margin, y=505,w=width,h=1, colour={ title_sp_color }},
        --DISKS 
            {x=margin, y=712,w=width,h=1, colour={ title_sp_color }},
        --NET 
            {x=margin, y=852,w=width,h=1, colour={ title_sp_color }},

    --Graph Spacer
        --System
            {x=margin, y=326,w=width,h=1, colour={ graph_sp_color }},
        --MEM
            {x=margin, y=534,w=width,h=1, colour={ graph_sp_color }},
        --DISKS-(/)-BOTTOM
            {x=margin, y=741,w=width,h=1, colour={ graph_sp_color }},
        --DISKS-(/mnt/backup)-TOP
            {x=margin, y=773,w=width,h=1, colour={ graph_sp_color }}, 
        --DISKS-(/mnt/backup)-BOTTOM
            {x=margin, y=802,w=width,h=1, colour={ graph_sp_color }},
        --NET-(UP)-TOP
            {x=margin, y=902,w=width,h=1, colour={ graph_sp_color }},
        --NET-(UP)-BOTTOM
            {x=margin, y=931,w=width,h=1, colour={ graph_sp_color }},
        --NET-(DOWN)-TOP
            {x=margin, y=963,w=width,h=1, colour={ graph_sp_color }},
        --NET-(DOWN)-BOTTOM
            {x=margin, y=992,w=width,h=1, colour={ graph_sp_color }},

    --Graph
        --CPU1
            {x=margin, y=125,w=width,h=height, colour={ graph_bg_color }},
        --CPU2
            {x=margin, y=150,w=width,h=height, colour={ graph_bg_color }},
        --CPU3
            {x=margin, y=175,w=width,h=height, colour={ graph_bg_color }},
        --CPU4
            {x=margin, y=200,w=width,h=height, colour={ graph_bg_color }},
        --CPU5
            {x=margin, y=225,w=width,h=height, colour={ graph_bg_color }},
        --CPU6
            {x=margin, y=250,w=width,h=height, colour={ graph_bg_color }},
        --CPU7
            {x=margin, y=275,w=width,h=height, colour={ graph_bg_color }},
        --CPU8
            {x=margin, y=300,w=width,h=height, colour={ graph_bg_color }},
        --MEM
            {x=margin, y=508,w=width,h=height, colour={ graph_bg_color }},
        --DISKS(/)
            {x=margin, y=715,w=width,h=height, colour={ graph_bg_color }},
        --DISKS(/mnt/backup)
            {x=margin, y=776,w=width,h=height, colour={ graph_bg_color }},
        --NET(Up)
            {x=margin, y=905,w=width,h=height, colour={ graph_bg_color }},
        --Net(Down)
            {x=margin, y=966,w=width,h=height, colour={ graph_bg_color }},
    }
